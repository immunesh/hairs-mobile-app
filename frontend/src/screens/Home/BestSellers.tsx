...
export function BestSellers({ products, isPending, isError, error, onRetry, navigation }: Props) {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Best Sellers</Text>
      <Text style={styles.subtitle}>Customer favourites, tried and loved</Text>
      ...
      {isPending ? (
        ...
        <View style={styles.statusBox}>
          <Text style={styles.statusText}>
            {getApiErrorMessage(error, "Could not load best sellers.")}
          </Text>
        ...
        <View style={styles.statusBox}>
          <Text style={styles.statusText}>No best sellers yet.</Text>
        </View>
      ) : (
        <>
          ...
          <Pressable
            onPress={() => navigation.navigate("ProductList", { bestSeller: true })}
