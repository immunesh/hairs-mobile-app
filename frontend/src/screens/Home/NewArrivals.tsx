...
export function NewArrivals({ products, isPending, isError, error, onRetry, navigation }: Props) {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>New Arrivals</Text>
      <Text style={styles.subtitle}>Fresh styles just landed</Text>
      ...
      {isPending ? (
        ...
        <View style={styles.statusBox}>
          <Text style={styles.statusText}>
            {getApiErrorMessage(error, "Could not load new arrivals.")}
          </Text>
        ...
        <View style={styles.statusBox}>
          <Text style={styles.statusText}>No new arrivals yet.</Text>
        </View>
      ) : (
        <>
          ...
          <Pressable
            onPress={() => navigation.navigate("ProductList", { newArrival: true })}
